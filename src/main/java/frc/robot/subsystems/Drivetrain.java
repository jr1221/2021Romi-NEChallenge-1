...
public class Drivetrain extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putData("Left Distance", m_leftEncoder);
    SmartDashboard.putData("Right Distance", m_rightEncoder);
    SmartDashboard.putData("Diff Drive", m_diffDrive);
    SmartDashboard.putData("Accelerometer", m_accelerometer);
